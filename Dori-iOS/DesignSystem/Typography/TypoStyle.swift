...
public enum TypoStyle {
  ...
  private var styleSpec: (weight: FontWeight, size: CGFloat) {
    ...
    case .heading(let heading):
      return (.bold, heading.size)
      
    case .subtitle(let subtitle):
      return (.semiBold, subtitle.size)
      
    case .body(let body):
      return (.medium, body.size)
      
    case .caption(let caption):
      return (.regular, caption.size)
    }
  }
...
public extension TypoStyle {
  ...
  enum SubTitle: Int, CaseIterable {
    case t12 = 12, t14 = 14, t15 = 15, t16 = 16
  ...
  enum Caption: Int, CaseIterable {
    case c11 = 11, c12, c13, c14, c15, c16, c20 = 20
