...
let package = Package(
  ...
  dependencies: [
    ...
    // swift-case-paths 1.8.0+ triggers CasePathsMacrosSupport-Swift.h not found on Xcode 26.3 macro host.
    // Pin to 1.7.x (develop CI June 15 used 1.7.3) which transitively constrains swift-navigation too.
