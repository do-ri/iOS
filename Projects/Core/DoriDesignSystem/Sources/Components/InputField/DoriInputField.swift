...
public struct InputFieldStyle: Equatable, Sendable {
  ...
  public static let `default` = InputFieldStyle(
    ...
    spacing: 8,
    normalBorderColor: UIAsset.Colors.borderInput.color,
    backgroundColor: UIAsset.Colors.bgPrimary.color,
    textColor: UIAsset.Colors.textPrimary.color,
    errorTextColor: Color(hex: "FF3B30"),
    placeholderColor: UIAsset.Colors.textPlaceholder.color,
    font: TypoSemantic.body(.sb3),
    unitColor: UIAsset.Colors.textSecondary.color,
